...
//   * https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Array/some
    ...
    function checkUsersValid(submittedUsers) {
      return function(receivedUsers) {
        return receivedUsers.every(function(receivedUser){
          return submittedUsers.some(function(submittedUser){
            return (receivedUser.id == submittedUser.id);
          })
        })
      };
    }
